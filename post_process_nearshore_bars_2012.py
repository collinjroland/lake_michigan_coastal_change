...
# Title: post_process_nearshore_bars_2012.py
# Author: Collin Roland
# Date Created: 20241231
# Summary: Filters nearshore bar peak and trough points to remove erroneous
identifications based on clustering and spread parameters, requires additional
manual filtering for finished product
# Date Last Modified: 20250102
# To do: Nothing
"""
# %% Import packages
...
proj_dir = homestr + r'\lake_michigan_bluff_delineation\2012_noaa_nearshore\shoreline_extract_param2'
dataset_name = '2012'
...
# %% Filtering peaks and troughs using clustering and linearity
...
all_peaks_manual_edit = gpd.read_file(r'D:\CJR\lake_michigan_bluff_delineation\manual_new_transects\manual_edit_points\2012_bar_peaks_pp_manual_edit.gpkg')
all_peaks_manual_edit_no_dups = all_peaks_manual_edit.drop_duplicates(subset = 'geometry')
all_peaks_manual_edit_no_dups.to_file(r'D:\CJR\lake_michigan_bluff_delineation\manual_new_transects\manual_edit_points\2012_bar_peaks_pp_manual_edit_no_dups.gpkg')
all_troughs_manual_edit = gpd.read_file(r'D:\CJR\lake_michigan_bluff_delineation\manual_new_transects\manual_edit_points\2012_bar_troughs_pp_manual_edit.gpkg')
all_troughs_manual_edit_no_dups = all_troughs_manual_edit.drop_duplicates(subset = 'geometry')
all_troughs_manual_edit_no_dups.to_file(r'D:\CJR\lake_michigan_bluff_delineation\manual_new_transects\manual_edit_points\2012_bar_troughs_pp_manual_edit_no_dups.gpkg')
