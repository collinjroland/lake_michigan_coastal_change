...
# Title: extract_shoreline_points_from_2012_transects.py
# Author: Collin Roland
# Date Created: 20241122
# Summary: Extracts shoreline points (particular elevation contour) and potential
nearshore bar peaks and troughs from 2012 JALBTCX DEM shore perpendicular transects
# Date Last Modified: 20250118
# To do: Look at improperly identified shoreline points associated with breakwaters
and post process nearshore bar identification
"""
# %% Import packages
...
data_path = homestr + r'\lake_michigan_bluff_delineation\2012_noaa_nearshore\delineation_points_text'
proj_dir = homestr + r'\lake_michigan_bluff_delineation\2012_noaa_nearshore\shoreline_extract_param4'
dataset_name = "2012"
...
params = {"shoreline_elevation": 175.92,
          "shoreline_elevation_mean": 177.31,
          "peak_lower_height": 171,
          "peak_upper_height": 175.5,
          "peak_prominence": 0.2,
...
# Debugging
# tile_name = '2012_NCMP_MI_Michigan_19_BareEarth_1mGrid_points.txt'
...
# %% Loop over transect data files (each tile)(parallelized)
# os.chdir(data_path)
# import joblib
# start_time = time.time()
